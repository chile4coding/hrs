...
export default function Recommended({ hospital }) {
  ...
  return (
    <div className=" card w-full md:w-full lg:w-full     p-4    bg-white   cursor-pointer   border-collapse border-0 hover:bg-white my-4">
        ...
        <div className=" flex col-span-2 items-end gap-2">
          ...
          <div className=" flex  flex-col justify-between  ">
            <div className="flex items-center gap-4 ">
              <p className="p-0 m-0 text-[11px] py-2 sm:text-[8px]  font-bold text-[#0F0F0F]">
                {name}
              </p>{" "}
              <p>{avgRate}</p>{" "}
            ...
            <h2 className="text-[12px] font-[300] text-[#838383] sm:text-[10px]">
              {address}
            </h2>
          </div>
        </div>
