...
export default function Dashboardmenus({details, icon, progress, data, visitors, value}) {
  return (
    <>
      ...
      <div className="card md:w-full  xl:w-full lg:w-full  h-full  sm:w-full bg-white   cursor-pointer  btn border-collapse border-0 hover:bg-white ">
        <div className="card-body   w-full">
          <div className=" flex  item-center gap-2 ">
            <div className="bg-[#EFF6FF] border-0  text-[#3188FF]  rounded-full  flex justify-center items-center ">
              {icon}
            </div>
            <h2 className="text-[#3188FF]  font-bold  text-[20px] font-Mukta capitalize  p-2 sm:text-base">
              {details}
            </h2>
          </div>
